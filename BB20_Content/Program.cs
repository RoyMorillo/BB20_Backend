...
using BB20_Content.Repository.Services;
...
builder.Services.AddDbContext<BB20_ContentContext>(options => options.UseSqlServer(connectionString));
...
{
    c.SwaggerDoc("v1", new() { Title = "BB20_Content", Version = "v1" });
