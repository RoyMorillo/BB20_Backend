...
using BB20_ContentAudios.Repository.Services;
...
builder.Services.AddDbContext<BB20_ContentAudioContext>(options => options.UseSqlServer(connectionString));
...
builder.Services.AddScoped<IContentAudioRepository, ContentAudioRepository>();
...
{
    c.SwaggerDoc("v1", new() { Title = "BB20_ContentAudios", Version = "v1" });
