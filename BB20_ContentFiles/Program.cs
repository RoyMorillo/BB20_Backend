...
using BB20_ContentFiles.Repository.Services;
using BB20_ContentFiles.Repository.Contracts;
using BB20_ContentFiles.SecurityModels;
...
builder.Services.AddDbContext<BB20_ContentFileContext>(options => options.UseSqlServer(connectionString));
...
builder.Services.AddScoped<IContentFileRepository, ContentFileRepository>();
...
{
    c.SwaggerDoc("v1", new() { Title = "BB20_ContentFiles", Version = "v1" });
