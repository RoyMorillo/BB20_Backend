...
using BB20_SubCategories.SecurityModels;
...
builder.Services.AddDbContext<BB20_SubCategoriesContext>(options => options.UseSqlServer(connectionString));
...
builder.Services.AddScoped<ISubCategoryThumbNailRepository, SubCategoryThumbNailRepository>();
